////This program demonstrates file merging and the use of CSS to determine text colors in HTML documents.
//
//#include <iostream>
//#include <stdlib.h>
//#include <fstream>
...
//using namespace std;
//
////This subclass of fstream adds the ability to write a string that is automatically embedded in an HTML span element with a color specification style
//
...
//
///*********************************
//Opens a specified file for reading or writing. The descr argument is used in prompting for the name of the file
//**********************************/
...
//	cin >> fileName;
//
//	//Determine whether the file should be opened for reading or writing based on the description (descr)
//	if (descr == "output")
