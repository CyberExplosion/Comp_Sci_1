////This program demonstrates the use of classes to put tabular data on the World Wide Web
//
//#include <iostream>
//#include <vector>
//#include <fstream>
...
//using namespace std;
//
////This class allows a 2-dimensions table expressed as a vectors of vector of strings to be transformed into HTML form.
//
//class HTMLTable {
//private:
...
//	vector<string>person2{ "Natashe Upenski", "513 Briacliff Ln", "412-672-1004" };
//
...
//
///***********************************
//Writes a row of the table, using the given tag for the table data. The tag maybe td for table data or th for table header
//************************************/
