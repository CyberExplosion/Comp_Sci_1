...
//}
//
//int LinkedList::recursiveSize(Node* ptr) {
//	if (ptr == nullptr) {
//		return 0;
//	}
//	else {
//		return 1 + recursiveSize(ptr->next);
//	}
//}
//
//void LinkedList::recursiveDisplay(Node* ptr) {
//	if (ptr != nullptr) {
//		cout << ptr->value << "  ";
...
//}
//
//LinkedList::Node* LinkedList::recursiveAdd(double value, Node* list) {
//	if (list == nullptr) {
//		return new Node(value);
//	}
//	else {
//		//Add the value to the end of the tail
//		list->next = recursiveAdd(value, list->next);
//		return list;
//	}
//}
//
